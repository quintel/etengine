...
ActiveRecord::Schema.define(version: 2021_12_15_120425) do
  ...
  create_table "scenario_attachments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
