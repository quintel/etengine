...
class ChemicalsAndSyntheticProducts < ActiveRecord::Migration[7.1]
  ...
  RENAME = {
    'capacity_of_energy_production_synthetic_kerosene_dispatchable' =>
      'capacity_of_energy_production_fischer_tropsch_synthetic_dispatchable',
    'investment_costs_co2_utilisation' => 'investment_costs_fischer_tropsch',
    'om_costs_co2_utilisation' =>
      'om_costs_methanol_synthesis',
    'om_costs_co2_utilisation' => 'om_costs_fischer_tropsch',
    'investment_costs_co2_utilisation' =>
      'investment_costs_methanol_synthesis',
    'transport_plane_using_kerosene_share' =>
      'transport_plane_using_kerosene_mix_share',
    'external_coupling_energy_chemical_other_transformation_external_coupling_node_bio_oil_output_share' =>
      'external_coupling_energy_chemical_other_transformation_external_coupling_node_bionaphtha_output_share',
    'external_coupling_energy_chemical_refineries_transformation_external_coupling_node_bio_oil_output_share' =>
      'external_coupling_energy_chemical_refineries_transformation_external_coupling_node_bionaphtha_output_share',
    'external_coupling_energy_chemical_fertilizers_transformation_external_coupling_node_bio_oil_output_share' =>
      'external_coupling_energy_chemical_fertilizers_transformation_external_coupling_node_bionaphtha_output_share',
    'output_of_energy_production_synthetic_methanol' =>
      'output_of_energy_production_methanol_synthesis'
  }.freeze

  REMOVE = %w[external_coupling_energy_production_synthetic_methanol_demand external_coupling_energy_production_synthetic_kerosene_demand]
  ...
  def up
    ...
    migrate_scenarios do |scenario|
      ...
      rename_and_remove_inputs(scenario)
    end
  end
  ...
  def rename_and_remove_inputs(scenario)
