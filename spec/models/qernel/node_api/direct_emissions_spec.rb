...
RSpec.describe Qernel::NodeApi::DirectEmissions do
  ...
  describe '#direct_reporting_emissions_co2_utilisation' do
    context 'with biogenic production emissions' do
      ...
      it 'reports CO2 utilisation equal to biogenic production emissions' do
        # Biogenic: 100 MJ * 0.05 kg/MJ = 5.0 kg CO2
        # CO2 Utilisation = Biogenic production emissions = 5.0 kg CO2
        expect(biogenic_plant).to have_query_value(:direct_reporting_emissions_co2_utilisation, 5.0)
      end
      ...
      it 'equals direct_co2_output_production_emissions_biogenic' do
        ...
        utilisation = biogenic_plant.query.direct_reporting_emissions_co2_utilisation

        expect(utilisation).to eq(biogenic)
      end
    end
    ...
    context 'with zero biogenic emissions' do
      ...
      let(:builder) do
        TestGraphBuilder.new.tap do |builder|
          ...
          builder.add(:fossil_producer, groups: [:primary_energy_demand], demand: 100)
      ...
      it 'reports zero CO2 utilisation' do
        # No biogenic inputs = 0 kg CO2 utilisation
        expect(fossil_plant).to have_query_value(:direct_reporting_emissions_co2_utilisation, 0.0)
      end
      ...
      it 'equals direct_co2_output_production_emissions_biogenic (zero)' do
        ...
        utilisation = fossil_plant.query.direct_reporting_emissions_co2_utilisation
  ...
  describe '#direct_reporting_emissions_biogenic_co2_emissions' do
    context 'with fossil CO2 input utilisation' do
      ...
      it 'reports biogenic CO2 emissions equal to fossil input utilisation' do
        # Total useful output: 100 MJ
        # Fossil CO2 utilisation: 100 MJ * 0.08 kg/MJ = 8.0 kg CO2
        # Biogenic CO2 emissions (reporting) = 8.0 kg CO2
        expect(co2_plant).to have_query_value(:direct_reporting_emissions_biogenic_co2_emissions, 8.0)
      end

      it 'equals direct_co2_input_utilisation_fossil' do
        fossil_util = co2_plant.query.direct_co2_input_utilisation_fossil
        biogenic_reporting = co2_plant.query.direct_reporting_emissions_biogenic_co2_emissions

        expect(biogenic_reporting).to eq(fossil_util)
      end
    end
    ...
    context 'with zero fossil CO2 utilisation' do
      ...
      let(:builder) do
        TestGraphBuilder.new.tap do |builder|
          ...
          builder.add(:producer, groups: [:primary_energy_demand], demand: 100)
      ...
      it 'reports zero biogenic CO2 emissions' do
        ...
        expect(regular_plant).to have_query_value(:direct_reporting_emissions_biogenic_co2_emissions, 0.0)
      end

      it 'equals direct_co2_input_utilisation_fossil (zero)' do
        fossil_util = regular_plant.query.direct_co2_input_utilisation_fossil
        biogenic_reporting = regular_plant.query.direct_reporting_emissions_biogenic_co2_emissions
