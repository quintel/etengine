...
describe Api::V3::ExportController do
  ...
  describe 'GET energy_flows.csv' do
    ...
    it 'renders the CSV' do
      expect(response.body).to eq(Api::V3::NodeFlowPresenter.new(scenario.gql.future.graph).as_csv)
    end
  end
  ...
  describe 'GET molecule_flows.csv' do
    ...
    it 'renders the CSV' do
      expect(response.body).to eq(
        Api::V3::NodeFlowPresenter.new(scenario.gql.future.molecules).as_csv
      )
    end
  end
end
