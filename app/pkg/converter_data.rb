...
#  cost_fuel_raw_material_expected_per_mj      :float
#  overnight_investment_ex_co2_per_mj_s        :float
#  overnight_investment_co2_capture_per_mj     :float
#  sustainable                                 :float
#  mainly_baseload                             :float
#  intermittent                                :float
#  cost_total_expected_per_mj                  :float
#  cost_om_expected_per_mj                     :float
#  cost_co2_expected_per_mje                   :float
#  cost_capital_expected_per_mj                :float
#  cost_finance_and_capital_expected_per_mj    :float
