...
function set_handles(start_x,end_x,start_y,end_y,start_percentage,end_percentage) {
  ...
  // alert(end_y);
   //  
   // if (growth_chart == false) {
   //    // console.log("old handel y:" + handle_2_y);
   // 
   //    a = (end_y / ((start_y > 1) ? start_y : 1));
   //    // console.log("diff: " + a);
   //    b = (a/2) + ((a*0.02) * (a*0.02));
   //    // console.log("extra factor: " + ((a*0.01)* (a*0.01)))
   //     // console.log("diff/2 + 10%: " + b);
   //    // console.log("new handel y:" + (handle_2_y - b));
   // 
   //    handle_2_y =(handle_2_y - b);
   //  }
    
   // if (growth_chart == false) {
   //     //alter end handle
   //   
   //     a = (end_y - start_y)//((start_y > 1) ? start_y : 1));
   //     // console.log(((start_y > 1) ? start_y : 1));
   //     b =  a * 0.02 * a * 0.03;
   //     handle_2_y =(handle_2_y - b);
   //         // console.log(handle_2_y)
   //     //alter start handle
   //   
   //     x = ((end_x - start_x)* (a * 0.0002));
   //   
   //     handle_1_x = handle_1_x + x;
   //         // handle_1_y = handle_1_y + (((end_y - start_y)*(x/20)));
   //     // console.log(handle_1_x);
   //   }
