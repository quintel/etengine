...
module Qernel
  class ConverterApi
    ...
    # Internal: Calculates the fixed costs of a converter in a given unit.
    #
    ...
    # of the Converter. There is therefore no method to 'calculate' this for one
    ...
    # the electrical output capacity and electrical efficiency of the converter.
    #
