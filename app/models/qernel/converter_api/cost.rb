...
module Qernel
  class ConverterApi
    ...
    #
    # @return [Float]
    #   Yearly variable operation and maintenance costs per typical input
    ...
    # The average yearly installment of capital cost repayments, assuming a
    # linear repayment scheme. That is why divided by 2, to be at 50% between
    # initial cost and 0.
    #
