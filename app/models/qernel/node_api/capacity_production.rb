...
module Qernel
  class NodeApi
    ...
    module CapacityProduction
      ...
      # The nominal electrical capicity of one unit.
      ...
      # The nominal heat capicity of one unit. This is both useable heat as steam_hot_water.
      ...
      # The nominal cooling capacity of one unit
      ...
      # The sum of all bio resources input.
      ...
      # The sum of all bio fuels input. This is biodiesel, bio kerosene, bio oil, bio lng, and bio
      # ethanol.
