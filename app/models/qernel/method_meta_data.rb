    ...
    def calculation_methods
      out = {
        ...
        :costs_per_plant => {
          ...
          'captured_biogenic_co2_emissions_costs_per(:plant)'        => {},
        ...
        :costs_per_node => {
          ...
          'captured_biogenic_co2_emissions_costs_per(:node)'    => {},
        ...
        :costs_per_mw_electricity => {
          ...
          'captured_biogenic_co2_emissions_costs_per(:mw_electricity)'    => {},
        ...
        :costs_per_mwh_electricity => {
          ...
          'captured_biogenic_co2_emissions_costs_per(:mwh_electricity)'    => {},
        ...
        :costs_per_mw_heat => {
          ...
          'captured_biogenic_co2_emissions_costs_per(:mw_heat)'    => {},
        ...
        :costs_per_mwh_heat => {
          ...
          'captured_biogenic_co2_emissions_costs_per(:mwh_heat)'    => {},
