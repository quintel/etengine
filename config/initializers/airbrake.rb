if ENV['AIRBRAKE_API_KEY'].present?
  ...
  # Rails applications. In doing so, it allows you to easily review errors, tie
  ...
  # prioritization of exceptions so that when errors occur, your team can
  ...
  Airbrake.configure do |c|
    ...
    # NOTE: This option *does not* work if you don't set the 'environment'
    # option.
